            ...
            while (menu != 7) {
                ...
                switch (menu) {
                    case 1:
                        ...
                        id = Integer.parseInt(JOptionPane.showInputDialog("Escolha o item pelo id"));
                        Loja.adicionarCarrinho(id, conexao);
                        Limpar();
                        break;
                    case 2:
                        Limpar();
                    ...
                    case 6:
                        Limpar();
                        int resposta = JOptionPane.showConfirmDialog(null, "Deseja exportar as vendas?","Exportação CSV",JOptionPane.YES_NO_OPTION);
